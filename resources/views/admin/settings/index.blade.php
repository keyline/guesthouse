...
@section('content')
    ...
    <form method="POST" action="{{ route('admin.settings.update') }}" enctype="multipart/form-data">
        ...
        <!-- TABS -->
        <div class="mb-4 border-b border-slate-200 bg-white">
            <div class="flex gap-0">
                <button type="button" onclick="switchTab('general')" class="tab-btn active px-4 py-3 border-b-2 border-slate-900 font-semibold text-slate-900 text-sm" data-tab="general">
                    General
                </button>
                <button type="button" onclick="switchTab('business')" class="tab-btn px-4 py-3 border-b-2 border-transparent font-semibold text-slate-600 text-sm hover:text-slate-900" data-tab="business">
                    Business
                </button>
                <button type="button" onclick="switchTab('contact')" class="tab-btn px-4 py-3 border-b-2 border-transparent font-semibold text-slate-600 text-sm hover:text-slate-900" data-tab="contact">
                    Contact
                </button>
                <button type="button" onclick="switchTab('banking')" class="tab-btn px-4 py-3 border-b-2 border-transparent font-semibold text-slate-600 text-sm hover:text-slate-900" data-tab="banking">
                    Banking
                </button>
                <button type="button" onclick="switchTab('booking')" class="tab-btn px-4 py-3 border-b-2 border-transparent font-semibold text-slate-600 text-sm hover:text-slate-900" data-tab="booking">
                    Booking
                </button>
                <button type="button" onclick="switchTab('policies')" class="tab-btn px-4 py-3 border-b-2 border-transparent font-semibold text-slate-600 text-sm hover:text-slate-900" data-tab="policies">
                    Policies
                </button>
            </div>
        </div>
    ...
    <script>
        function switchTab(tabName) {
            ...
            // Update button state
            event.target.classList.add('border-slate-900', 'text-slate-900', 'font-semibold');
